...
public class MongoDBTableCreation {
	...
	public static void main(String[] args) throws ParseException {
		...
		db.getCollection("users").insertOne(new Document().append("first_name", "Xiangyu").append("last_name", "Xiao")
		...
		// Different to MySQL, users table in MongoDB also has categories info
